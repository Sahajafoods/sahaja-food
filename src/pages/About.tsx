          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1.3fr 1fr', gap: 80, alignItems: 'start' }} className="about-bio-grid">
            ...
            <div style={{ position: 'sticky', top: 100 }}>
              <div className="reveal-r">
                ...
                <a href="https://www.instagram.com/sah.ajafood?igsh=MXM5Z3N2ZnA3YmZvOA%3D%3D&utm_source=qr" target="_blank" rel="noopener" style={{ display: 'inline-flex', alignItems: 'center', gap: 10, color: 'var(--cu)', fontSize: '.9rem', fontWeight: 600, textDecoration: 'none' }}>
